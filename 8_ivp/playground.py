...
def solve_ode(step_func, t_0, T, h_0, N_x, eps, rhs_func, initial_conditions, THETA, color=Fore.LIGHTRED_EX):
    ...
    while t < T:
        h2 = h / 2
        y_next    = step_func(rhs_func, t   , y,         h,  kounter) if memo["h"]    is None else memo["h"]
        y_next_12 = step_func(rhs_func, t   , y,         h2, kounter) if memo["h_12"] is None else memo["h_12"]
...
heun = solve_ode(heun_step, t_0, T, h_0, N_x, eps, fs, initial_conditions, THETA=2, color=Fore.BLUE)
